.class final Lcom/google/android/gms/internal/zzbkz;
...
.method private constructor <init>(Landroid/os/Looper;Landroid/content/Context;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/internal/zzbkz;->mContext:Landroid/content/Context;

    return-void
.end method

.method synthetic constructor <init>(Landroid/os/Looper;Landroid/content/Context;Lcom/google/android/gms/internal/zzbky;)V
    .locals 0

    invoke-direct {p0, p1, p2}, Lcom/google/android/gms/internal/zzbkz;-><init>(Landroid/os/Looper;Landroid/content/Context;)V
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    iget-object v0, p0, Lcom/google/android/gms/internal/zzbkz;->mContext:Landroid/content/Context;

    const-string v1, "EventCallback"

    const-string v2, "Don\'t know how to handle this event"

    invoke-static {v0, v1, v2}, Lcom/google/android/gms/internal/zzbkb;->zzm(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v1, v0}, Lcom/google/android/gms/internal/zzbkb;->zzy(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/drive/events/zzl;->zzanf()Lcom/google/android/gms/common/data/DataHolder;
    ...
    invoke-direct {v1, v2}, Lcom/google/android/gms/internal/zzbla;-><init>(Lcom/google/android/gms/drive/MetadataBuffer;)V

    :cond_1
    invoke-virtual {v0}, Lcom/google/android/gms/drive/events/zzl;->zzang()Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {v0}, Lcom/google/android/gms/drive/events/zzl;->zzanh()I
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/drive/events/zzn;->zzani()Lcom/google/android/gms/internal/zzbhk;

    move-result-object v0

    new-instance v1, Lcom/google/android/gms/internal/zzbhi;

    invoke-direct {v1, v0}, Lcom/google/android/gms/internal/zzbhi;-><init>(Lcom/google/android/gms/internal/zzbhk;)V
